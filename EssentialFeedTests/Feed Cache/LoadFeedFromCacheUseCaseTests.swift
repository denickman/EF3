...
class LoadFeedFromCacheUseCaseTests: XCTestCase {
    ...
    // happy path
    func test_load_deliversNoImagesOnEmtpyCache() {
        let (sut, store) = makeSUT()
    ...
    func test_load_deliversCachedImagesOnLessThanSevenDaysOldCache() {
        ...
        let lessThanSevenDaysOldTimestamp = fixedCurrentDate.adding(days: -7).adding(seconds: 1) //  currentDate - 7 days + 1 second
    ...
    // delete a cache on retrieval error
